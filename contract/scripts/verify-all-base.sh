...
ALLOWED_TARGETS_ENFORCER=$(jq -r '.base.allowedTargetsEnforcer' deployments-base.json)
ALLOWED_METHODS_ENFORCER=$(jq -r '.base.allowedMethodsEnforcer' deployments-base.json)
TIMESTAMP_ENFORCER=$(jq -r '.base.timestampEnforcer' deployments-base.json)
LIMITED_CALLS_ENFORCER=$(jq -r '.base.limitedCallsEnforcer' deployments-base.json)
NATIVE_TOKEN_PAYMENT_ENFORCER=$(jq -r '.base.nativeTokenPaymentEnforcer' deployments-base.json)
